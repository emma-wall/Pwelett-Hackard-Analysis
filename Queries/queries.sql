...
-- number of emploees born between 1952-1955 who were hired between 1985 and 1988
SELECT COUNT(first_name)
FROM employees
WHERE (birth_date BETWEEN '1952-01-01' AND '1955-12-31') 
AND (hire_date BETWEEN '1985-01-01' AND '1988-12-31');

--save employees born between 1952 and 1955 who were hired from 1985-1988 
SELECT first_name, last_name
...
--create new table with retirement_info to add employee number
--drop original table
...
--Retirement info of sales and Development
SELECT ri.emp_no, ri.first_name, ri.last_name, d.dept_name
